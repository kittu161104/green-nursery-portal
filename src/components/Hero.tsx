  ...
  return (
    <div className="relative overflow-hidden bg-black">
      <div className="absolute inset-0 z-0">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-green-950/50 to-black/80 backdrop-blur-sm"></div>
      </div>

      <div className="relative pt-16 pb-32 sm:pt-24 sm:pb-40">
        <div className="mx-auto mt-16 max-w-7xl px-4 sm:mt-24 sm:px-6">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-green-50 sm:text-5xl md:text-6xl">
              <span className="block">Bring Nature</span>
              <span className="block text-green-400">Into Your Home</span>
            </h1>
            <p className="mx-auto mt-3 max-w-md text-base text-green-200 sm:text-lg md:mt-5 md:max-w-3xl md:text-xl">
            ...
            <div className="mx-auto mt-8 max-w-md sm:flex sm:justify-center md:mt-10">
              ...
              <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
                <Link to="/about">
                  <Button variant="outline" className="w-full border-green-600 text-green-200 hover:bg-green-900/30 md:py-3 md:text-lg">
                    Learn More
                  </Button>
                </Link>
              </div>
